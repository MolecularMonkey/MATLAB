...
while ~extflg
    LoadorRead=questdlg('Do you Want to Load 2D Data from Scratch or Read pre-processed 2D Data?','Load or Read ?',...
        'Read pre-loaded data either saved or in Workspace?','Load raw 2D spectra?','Read pre-loaded data either saved or in Workspace?');
      switch LoadorRead
        case 'Read pre-loaded data either saved or in Workspace?'
