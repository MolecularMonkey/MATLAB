function TwoD2Multiple1D_V1(RRRefBU,Excitation1,Increment,Excitation2,MatFilePath,MatFileName)
...
% Making a new folder so that every file is saved in that folder
% Do we have the path to .mat file? 
if ~exist('MatFilePath','var') 
    MatFilePath=pwd;
    MatFileName=erase(RRRefBU{2,4}{2,3},' ');
else
    MatFileName=erase(MatFileName,' ');
end
