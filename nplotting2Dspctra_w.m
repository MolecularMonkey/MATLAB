...
elseif strcmp(answer2,'No, I will use the exisiting RRRef or Ref')
    ...
    elseif exsst==1 && ~exst==1
     ...
     RRRef_Shuld_B_deleted=1; % Because We are not so sure about RRRef,esp. ref path and ref file location
       if exsst1 && exsst2
...
%% Name of the sample
        ...
        RRRefBU=RRRef;
        %Saving Part 
        xlswrite(str3,FinalSpectra,'Final_Spectra')
        save(str2,'RRRefBU')
        ...
        clear str1 str2 szeEmission szeExcitation sfile spath SpectrumID
